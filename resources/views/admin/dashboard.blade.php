    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        @php
            $cards = [
                ...
                ['label' => 'Wisata & UMKM', 'value' => $summary['total_wisata'] + $summary['total_umkm'], 'sub' => $summary['total_wisata'].' wisata, '.$summary['total_umkm'].' UMKM', 'color' => 'bg-[#009B3A]/10 text-[#009B3A]', 'route' => 'admin.wisata.index'],
            ];
        @endphp
