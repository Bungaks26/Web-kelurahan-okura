                        ...
                        <tr class="hover:bg-slate-50">
                            ...
                            <td class="px-5 py-3.5">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    {{-- Approve hanya untuk wisata pending --}}
                                    @if ($wisata->status === 'pending')
                                        <form action="{{ route('admin.wisata.approve', $wisata) }}"
                                              method="POST"
                                              class="inline"
                                              onsubmit="return confirm('Setujui wisata ini?')">
                                    ...
                                    {{-- Hapus --}}
                                    <form action="{{ route('admin.wisata.destroy', $wisata) }}"
                                          method="POST"
