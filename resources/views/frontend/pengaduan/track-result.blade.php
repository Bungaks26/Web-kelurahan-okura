...
<section class="max-w-2xl mx-auto px-4 sm:px-6 pt-28 pb-16">
    <div class="bg-white rounded-2xl shadow-md p-6 sm:p-8 border border-slate-100">
        ...
        {{-- Tambahan preview lampiran --}}
        @if ($pengaduan->lampiran)
            <div class="mb-6">
                <p class="text-xs font-semibold text-slate-400 mb-2">Lampiran</p>

                <a href="{{ asset('storage/' . $pengaduan->lampiran) }}"
                target="_blank"
                class="inline-flex items-center gap-2 text-sm text-emerald-600 hover:underline">
