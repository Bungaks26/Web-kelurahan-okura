...
<section class="pt-28 pb-16 bg-slate-50 min-h-screen">
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-5 mb-6 text-sm text-slate-600">
            ...
            <ul class="list-disc pl-5 space-y-1">
                <li>Pastikan lokasi kejadian ditulis dengan jelas.</li>
                <li>Sertakan foto pendukung bila memungkinkan.</li>
                <li>Simpan kode tiket untuk memantau perkembangan pengaduan.</li>
            </ul>
