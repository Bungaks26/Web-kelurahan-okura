...
<section class="pt-28 pb-16">
    <div class="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10 items-stretch">
            @foreach ($jenisSurat as $key => $surat)
                <div class="bg-white rounded-2xl shadow-md border border-slate-100 p-6 flex flex-col h-full">
                    <div class="flex-1">
